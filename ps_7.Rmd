...
california <- election_data %>%
  ...
  select(trump16, clinton16, romney12, obama12, demhouse16, rephouse16, white_pct, black_pct, hispanic_pct, nonwhite_pct, foreignborn_pct, median_hh_inc, lesshs_pct, lesscollege_pct) %>% 
...
#renaming the variables so they look nice in my app  
   mutate(`Voted Trump 16` = as_factor(trump16),
          ...
          `Voted Romney 12` = as_factor(romney12),
...
app_data %>% write_rds("ps_7-2018-elections/app_datafile.rds")
